    ...
    where TEntity : class
{
                                              ...
                                              CancellationToken cancellationToken = default)
    {
        try
        {
            var updateExpression = ExpressionGenerator<TEntity>.BuildUpdateExpression(model);
                                              ...
                                              CancellationToken cancellationToken = default)
    {
        try
        {
            ...
            Expression<Func<SetPropertyCalls<TEntity>, SetPropertyCalls<TEntity>>> updateExpression = ExpressionGenerator<TEntity>.BuildUpdateExpression(model);
            return await query.ExecuteUpdateAsync(updateExpression, cancellationToken);
        }
        catch (Exception exception)
        {
